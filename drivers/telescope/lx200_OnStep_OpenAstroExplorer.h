...
enum OAE_ResponseErrors {OAE_RES_ERR_FORMAT = -1001};

enum OAE_Errors {OAE_ERR_NONE, OAE_ERR_MOTOR_FAULT, OAE_ERR_ALT_MIN, OAE_ERR_LIMIT_SENSE, OAE_ERR_DEC, OAE_ERR_AZM, OAE_ERR_UNDER_POLE, OAE_ERR_MERIDIAN, OAE_ERR_SYNC, OAE_ERR_PARK, OAE_ERR_GOTO_SYNC, OAE_ERR_UNSPECIFIED, OAE_ERR_ALT_MAX, OAE_ERR_GOTO_ERR_NONE, OAE_ERR_GOTO_ERR_BELOW_HORIZON, OAE_ERR_GOTO_ERR_ABOVE_OVERHEAD, OAE_ERR_GOTO_ERR_STANDBY, OAE_ERR_GOTO_ERR_PARK, OAE_ERR_GOTO_ERR_GOTO, OAE_ERR_GOTO_ERR_OUTSIDE_LIMITS, OAE_ERR_GOTO_ERR_HARDWARE_FAULT, OAE_ERR_GOTO_ERR_IN_MOTION, OAE_ERR_GOTO_ERR_UNSPECIFIED};
enum OAE_RateCompensation {OAE_RC_NONE, OAE_RC_REFR_RA, OAE_RC_REFR_BOTH, OAE_RC_FULL_RA, OAE_RC_FULL_BOTH}; //To allow for using one variable instead of two in the future

enum OAE_MountType {OAE_MOUNTTYPE_GEM, OAE_MOUNTTYPE_FORK, OAE_MOUNTTYPE_FORK_ALT, OAE_MOUNTTYPE_ALTAZ};

enum OAE_OnStepVersion {OAE_OSV_UNKNOWN, OAE_OSV_OnStepV1or2, OAE_OSV_OnStepV3, OAE_OSV_OnStepV4, OAE_OSV_OnStepV5, OAE_OSV_OnStepX};

class LX200_OnStep_OpenAstroExplorer : public LX200Generic, public INDI::WeatherInterface, public INDI::RotatorInterface
{
    public:
        LX200_OnStep_OpenAstroExplorer();
        ~LX200_OnStep_OpenAstroExplorer() {}
    ...
    protected:
        ...
        //Mount information
        OAE_MountType OSMountType = OAE_MOUNTTYPE_GEM; //default to GEM
        ...
        */
        ...
        OAE_OnStepVersion OnStepMountVersion = OAE_OSV_UNKNOWN;
    ...
    private:
        void resetPolarAdjustmentState();
        void setSimulatedPolarScales();
        void queryPolarAdjustmentAxes();
        bool queryPolarAxis(int axisNumber, const char *axisLabel, double &scale);
        bool queryPolarAxisAvailability(int axisNumber, const char *axisLabel);
        bool queryPolarAxisScale(int axisNumber, const char *axisLabel, double &scale);
        bool parsePositiveFiniteDouble(const char *response, double &value) const;
        bool processPolarAdjustmentNumber(INDI::PropertyNumber &property, const char *axisLabel,
                                          double values[], char *names[], int n);
        bool processPolarJog(INDI::PropertySwitch &commandProperty, const char *axisLabel, int axisNumber,
                             INDI::PropertyNumber &offsetProperty, bool axisAvailable,
                             double arcsecondsPerRawStep);
        bool formatPolarJogCommand(int axisNumber, int64_t rawSteps, char *cmd, size_t cmdLength) const;

        INDI::PropertyNumber OAEAltitudeJogNP {1};
        INDI::PropertySwitch OAEAltitudeJogSP {1};
        INDI::PropertyNumber OAEAzimuthJogNP {1};
        INDI::PropertySwitch OAEAzimuthJogSP {1};

        bool OAEAltitudeAxisAvailable = false;
        bool OAEAzimuthAxisAvailable = false;
        double OAEAltitudeArcsecondsPerRawStep = 0.0;
        double OAEAzimuthArcsecondsPerRawStep = 0.0;
